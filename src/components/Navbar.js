                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-3">
                                <Link to="/">
                                    <img className="img-responsive" src={logo} width="184" height="55" alt="SellCell.com"/>
                                </Link>
                            </div>
                            <div className="col-lg-5">
                                <div className="no1-site">
                            ...
                            <div className="col-lg-4">
                                <a className="buy-phone active" href="/buy/">BUY</a>
                                <a className="sell-phone" href="/sell/">SELL</a>
                            </div>
                        </div>
                    </div>
                </div>

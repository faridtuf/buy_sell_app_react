                        ...
                        <div className="col-lg-6">
                            <div className="card2 card border-0 px-4 py-5">
                                ...
                                <div className="row px-3">
                                    ...
                                    <input className="mb-4" type="text" name="email"  placeholder="Enter a valid email address"/> </div>
                                <div className="row px-3"> 
                                    <label className="mb-1">
                                ...
                                <div className="row mb-4 px-3"> <small className="font-weight-bold">Don't have an account? <a href="/signup" className="text-danger ">Register</a></small> </div>
                            </div>
                        </div>
                    </div>
